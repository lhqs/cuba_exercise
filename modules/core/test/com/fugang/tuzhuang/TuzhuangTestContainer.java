...
public class TuzhuangTestContainer extends TestContainer {

    public TuzhuangTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/fugang/tuzhuang/app.properties",
    ...
    public static class Common extends TuzhuangTestContainer {

        public static final TuzhuangTestContainer.Common INSTANCE = new TuzhuangTestContainer.Common();
